...
{
//	create_proc_entry("sequence", 0, NULL);
//	proc_create      ("sequence", 0, NULL, &ct_file_ops);

	proc_create("currentime", 0, jit_currentime, NULL);
	proc_create("jitbusy", 0, jit_fn, (void *)JIT_BUSY);
	proc_create("jitsched",0, jit_fn, (void *)JIT_SCHED);
	proc_create("jitqueue",0, jit_fn, (void *)JIT_QUEUE);
	proc_create("jitschedto", 0, jit_fn, (void *)JIT_SCHEDTO);

	proc_create("jitimer", 0, jit_timer, NULL);
	proc_create("jitasklet", 0, jit_tasklet, NULL);
	proc_create("jitasklethi", 0, jit_tasklet, (void *)1);
